...
import egalite from '@/public/images/egalite_2.png'
    ...
    <footer>
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 gap-20 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-6 lg:col-span-5">
              <div className="mb-2">
                {/* Logo */}
                <Link href="/" >
                  <img className="w-40 h-25 mb-4" src={egalite.src} />
                </Link>
              </div>
            </div>

            {/* 2nd, 3rd and 4th blocks */}
            <div className="md:col-span-12 lg:col-span-7 grid sm:grid-cols-0 gap-8">
              ...
              {/* 4th block */}
              <div className="text-sm text-gray-200 font-medium mb-1 md:text-right md:order-1">
                <h6 className="text-gray-200 font-medium mb-1">Address</h6>
                <ul>
                  <li className="mb-1">
                    <div className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">
                      Egalite Digital Experience Inc.<br />
                      539 W Commerce St STE 6688<br />
                      Dallas, Texas 75208
                    </div>
                  </li>
                </ul>
          ...
          {/* Bottom area */}
          <div className="md:flex md:items-center md:justify-center justify-center">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm md:mr-0 md:order-2 md:mb-0">
              Egalite&copy;2023 All rights reserved.
            </div>
